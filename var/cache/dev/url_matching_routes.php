...
return [
    ...
    [ // $staticRoutes
        ...
        '/update' => [[['_route' => 'app_update', '_controller' => 'App\\Controller\\UpdateController::index'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
    ...
    [ // $dynamicRoutes
        ...
        388 => [
            [['_route' => 'generated_pdf', '_controller' => 'App\\Controller\\PdfController::generatePdf'], ['id'], null, null, false, true, null],
